...
if __name__ == '__main__':    
    make_chaizi_knowledge('./info', './output/result_chaizi_freq.txt', './output/result_phrase.txt', './output/result_chaizi_knowledge.json')
    make_normal_knowledge('./info', './output/result_single_word.txt', './output/result_phrase.txt', './output/result_single_knowledge.json')
